...
public class jAssets {
    ...
    private static HashMap<Color,Texture> colorTextures = new HashMap<Color, Texture>();
     ...
     * @param file
     */
    public static void loadTextureAs(Color key, String file){
     ...
     * @return
     */
    public static Texture getTexture(Color key) {
        Texture text = colorTextures.get(key);
        try { if (colorTextures == null) { throw new Exception("No image for key" + key + " found!"); } } catch (Exception e) { e.printStackTrace(); }
        return text;
    }
    /**
